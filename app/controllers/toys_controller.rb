class ToysController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @toy.save
        format.html { redirect_to @toy, notice: 'Toy successfully created.' }
  ...
  def update
    respond_to do |format|
      if @toy.update(toy_params)
        format.html { redirect_to @toy, notice: 'Toy successfully updated.' }
  ...
  def destroy
    @toy.destroy
    respond_to do |format|
      format.html { redirect_to toys_url, notice: 'Toy successfully deleted.' }
